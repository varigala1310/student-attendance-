...
if($R[user_id])
{
$statement = "UPDATE `user` SET"; $cond = "WHERE `user_id` = '$R[user_id]'";
...
$SQL= $statement." `user_level_id` = '$R[user_level_id]',
".
$condQuery
."
...
header("Location:../user.php?user_id=".$_SESSION['user_details']['user_id']."&msg=
Your
