...
$SQL="SELECT * FROM `attendance`, `month`, `student` WHERE student_id =
attendance_student_id And month_id = attendance_month_id";
...
<td>
<?=$data[attendance_intime]?></td>
<td><?=$data[attendance_outtime]?></td>
<td><?=$data[attendance_description]?></td>
<td style="text-align:center">
<a href="attendance.php?attendance_id=<?php
echo $data[attendance_id] ?>">Edit</a> | <a
href="Javascript:delete_attendance(<?=$data[attendance_id]?>)">Delete</a>
</td>
</td>
</tr>
<?php } ?>
