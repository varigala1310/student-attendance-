...
{
$SQL="SELECT * FROM attendance, month, student WHERE month_id =
attendance_month_id AND student_id = attendance_student_id AND
attendance_id =
...
<?=$data[attendance]?> Attendance Details</h4>
<?php
if($_REQUEST['msg']) {
?>
...
<div><img src="<?=$SERVER_PATH.'uploads/'.$data[attendance_image]?>"
