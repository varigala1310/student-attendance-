...
AND month_id = attendance_month_id";
if($_REQUEST[student_id])
{
$SQL="SELECT * FROM `attendance`, `month`, `student` WHERE student_id =
attendance_student_id AND month_id = attendance_month_id AND student_id =
$_REQUEST[student_id]";
}
...
\ <div class="static">
<table class="table table-striped table-advance table-hover" id="mydatatable"
style="color:#000000">
<thead>
<tr class="tablehead bold">
<td scope="col">ID</td> <td scope="col">Student</td>
