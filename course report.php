...
<div class="clear"></div>
<div id="content_sec"> <div class="col1" style="width:100%">
<div class="contact"> <h4 class="heading colr">Course Report</h4>
<?php
if($_REQUEST['msg']) {
?>
<div class="msg">
...
<div class="static"> <table class="table table-striped table-advance table-hover"
id="mydatatable" style="color:#000000">
<thead>
<tr class="tablehead bold"> <td scope="col">ID</td>
...
<a href="course.php?course_id=<?php echo $data[course_id]
?>">Edit</a> |
<a href="Javascript:delete_course(<?=$data[course_id]?>)">Delete</a>
</td>
</td>
</tr>
<?php
...
</div> <input type="hidden" name="act" />
